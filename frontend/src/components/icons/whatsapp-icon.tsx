/**
 * WhatsApp brand mark (Simple Icons path), drawn with `currentColor`.
 *
 * Lives on its own because two very different surfaces need the identical
 * glyph — the footer's social row and the floating support button — and we
 * stay lucide-only rather than pulling in react-icons for a single path.
 */
